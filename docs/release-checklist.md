...
6. Commit the release state, then create and push `v0.1.0`. Only the tag event creates the GitHub Release.

Linux and macOS prebuilt archives are not part of v0.1.0.
